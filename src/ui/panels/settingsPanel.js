...
export function createSettingsPanelContent(config) {
  return `
...
export function createGeneralSettings(config) {
  return `
...
export function createVideoSettings(config) {
  return `
    <div class="setting-group">
      <h3>显示元素</h3>
      <label>
...
export function createLiveSettings(config) {
  return `
    <div class="setting-group">
      <h3>显示元素</h3>
      <label>
...
export function createImportExportSettings() {
  return `
    <div class="setting-group">
      <h3>配置导入</h3>
...
export function createAdvancedSettings(config) {
  return `
    <div class="setting-group">
      <h3>高级功能</h3>
      <label>
...
export function createAutoExecutorSettings() {
  return `
    <div class="setting-group">
      <h3>自动执行控制器</h3>
